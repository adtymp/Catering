...
<body class="bg-gray-100">
    ...
    <div class="grid md:grid-cols-2 gap-y-2 gap-x-2 p-3">
        ...
        <div class="md:col-span-1">
            ...
            <div class="w-full border-gray-200 p-4 bg-white text-xs shadow-md">
                <ul class="list-disc border-b">
                    <p class="mb-2 text-sm font-semibold">Rincian Pesanan :</p>
                ...
                <ul class="space-y-4 text-sm text-slate-600 mt-3">
                    ...
                    <hr class="border-slate-300" />
                    <li>
                        <div x-data="{ bukti: false }" class="text-center">
