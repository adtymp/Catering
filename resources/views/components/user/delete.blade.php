<div x-show="deleteAccount" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
        ...
        <form method="POST" action="{{ route('profile.delete') }}" class="mt-6 space-y-4">
            @csrf
            <div>
