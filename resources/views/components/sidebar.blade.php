<div class="flex">
    ...
    <div
        ...
        <a href="/dashboard" class="relative flex items-center text-gray-400 hover:text-white hover:bg-black p-2">
    ...
    <div class="flex-1" x-data="{ isOpen: false }">
        ...
        <div
            ...
            <div class="flex items-center space-x-2">
                <span class="text-gray-700 font-medium hidden sm:block">Nama User</span>
