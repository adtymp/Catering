<div class="flex">
    ...
    <div
        ...
        <a href="admindashboard" class="relative flex items-center hover:text-white hover:bg-black p-2">
        ...
        <div class="relative flex items-center hover:text-white hover:bg-black p-2">
        ...
        <a href="product" class="relative flex items-center hover:text-white hover:bg-black p-2">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button class="relative flex items-center hover:text-white hover:bg-black p-2">
                <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 512 512">
    ...
    <div class="flex-1" x-data="{ isOpen: false }">
        ...
        <div
            ...
            <div class="flex items-center space-x-2">
                ...
                @endif
                <button @click="isOpen = !isOpen" class="w-9 h-9 rounded-full border-white border-2 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" viewBox="0 0 24 24" fill="#e1c356">
                        <path fill="#ffffff" fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" />
                    </svg>
                </button>
                <div x-show="isOpen"
