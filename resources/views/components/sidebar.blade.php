<div class="flex">
    ...
    <div
        ...
        <a href="{{ route('orderAdmin') }}" class="relative flex items-center hover:text-white hover:bg-black p-2 ml-2">
    ...
    <div class="flex-1" x-data="{ isOpen: false }">
        ...
        <div
            ...
            <div class="flex items-center space-x-2 mr-4">
                @if (Auth::check())
                <span class="font-medium hidden sm:block mr-4">{{ Auth::user()->name }}</span>
                @endif
