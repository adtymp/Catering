<div x-show="postOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-lg w-80">
        ...
        <form method="POST" action="{{ route('productroom.banner.add') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <h3 class="text-xl text-center font-bold text-amber-400">Tambah Postingan</h3>
